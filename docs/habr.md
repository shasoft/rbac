...
Потребовалось мне сделать свою реализацию проверки прав для PHP. В итоге эта разработка стала отдельным [пакетом](https://github.com/shasoft/rbac). Возможно кому-то пригодится. В статье рассказываю как это работает.
